    ...
    <div class="container">
        <div class="row row-30">
            <div class="col-md-4 col-xl-5">
                <div class="pr-xl-4"><a class="brand" href="index.html"><img src="logo.png" height="100px" width="100px"></a>
            ...
            <div class="col-md-2">
                ...
                <dl class="contact-list">
                    <dt>Address:</dt>
                    <dd>Shankmul Ward no 31
                        Kathmandu, Nepal</dd>
                </dl>
                <dl class="contact-list">
                    <dt>Email:</dt>
                    <dd><a href="mailto:#">houseofbooksnepal@gmail.com</a></dd>
                </dl>
                <dl class="contact-list">
                    <dt>Phone:</dt>
                    <dd><a href="tel:#">+977-9818352602</a> <span>or</span> <a href="tel:#">+977-9742537210</a>
                    </dd>
                </dl>
            </div>
            ...
            <div class="col-md-3 col-xl-3">
                ...
                <ul class="nav-list">
                    <img src="E-Sewa.png" alt="ESEWA" width="45%"> <img src="khalti.png" alt="Khalti" width="45%" >
                </ul>
            </div>
        </div>
    </div>
...
<div class="loader">
    <div class="container">
        <p class="rights pt-4"><span>©  </span><span class="copyright-year">2021</span><span> </span><span>House of Books</span><span>. </span><span>All Rights Reserved.</span></p>
...
{{--                </h3>--}}
{{--                <ul class="nav nav-pills nav-stacked">--}}
{{--                    <li><a href="catalog-list.html">SEE</a></li>--}}
{{--                    <li><a href="catalog-list.html">NEB XI</a></li>--}}
{{--                    <li><a href="catalog-list.html">NEB XII</a></li>--}}
{{--                    <li><a href="catalog-list.html">Solutions</a></li>--}}
{{--                </ul>--}}
{{--            </div>--}}
{{--            <div class="f-menu">--}}
{{--                <h3>--}}
